...
<div class="flex gap-4 w-full">
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                        ...
                        <tr>
                            ...
                            <td class="whitespace-nowrap px-3 py-4 text-sm font-medium text-right">
                                <a href="/dashboard?tab=cinema&mode=delete&cinema=<%=cinema.getTheaterId()%>" class="text-red-600 hover:text-red-900">Remove</a>
                            </td>
    ...
    <div class=" w-1/3 border-l-2 border-gray-200 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        <form action="<%=mode.equals("edit")? "/dashboard?tab=cinema&mode=edit&cinema="+theater.getTheaterId() : "/dashboard?tab=cinema" %>"
              method="post">
